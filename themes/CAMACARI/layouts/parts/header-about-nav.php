<nav id="about-nav" class="alignright clearfix">
    <h1 id="organization-logo"><a href="http://secult.camacari.ba.gov.br/" target="_blank"><img src="<?php $this->asset('img/logo-instituicao.png'); ?>" alt="Secult Camaçari/BA"></a></h1>
