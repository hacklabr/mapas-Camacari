...
return [
    ...
    "text:home-register.title" => i::__("Faça seu cadastro e colabore com o Mapa Cultural de Camaçari"),
    "text:home-register.description" => i::__("Contribua com a plataforma livre e interativa de mapeamento do cenário cultural e instrumento de governança digital no aprimoramento da gestão pública, dos mecanismos de participação e da democratização do acesso às políticas culturais promovidas na cidade."),
    'text:home-developers.description' => 'Além disso, Mapa Cultural de Camaçari é um software livre, criado em parceria entre a hacklab/, secretarias de cultura, organizações não governamentais, empresas e coletivos que investem na plataforma. Você pode contribuir para o seu desenvolvimento através do GitHub.',
